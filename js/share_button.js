...
var a2a = a2a || {
  ...
  kit: function (i, e) {
    ...
    z && !isNaN(z) && (a2a.svg.load(), B && "unset" != B && a2a.svg.works() && (F && "unset" != F && (M.backgroundColor = F), L && "unset" != L.trim() && (L = L.trim())), g.style.lineHeight = j.height = j.lineHeight = D, j.width = 2 * z + "px", j.fontSize = "16px", O && (j.height = j.lineHeight = z / 2 + "px", j.fontSize = "10px", j.width = z + "px"), H && a2a.scrollToggle(g, H), 32 != z && (M.backgroundSize = M.height = M.lineHeight = M.width = D, j.borderRadius = M.borderRadius = (.14 * z).toFixed() + "px", j.fontSize = (parseInt(j.height, 10) + (O ? 4 : 0)) / 2 + "px")), a2a.kit.facebook_like = function () {
      ...
      q.appendChild(r), a2a.kit.twitter_tweet_script || (t = document, n = "twitter-wjs", l = t.getElementsByTagName("script")[0], t.getElementById(n) || ((i = t.createElement("script")).id = n, i.src = "https://platform.twitter.com/widgets.js", l.parentNode.insertBefore(i, l), window.twttr = window.twttr || (o = {
        _e: [],
        ready: function (e) {
          o._e.push(e)
        }
    ...
    for (var R = 0; R < w; R++) {
      var $, G, U, W, q = k[R],
        ...
        de = "",
        ue = {};
      if (K) e.target = q, a2a.init(s, e), oe = "0166FF", ne = X = "a2a", ce = !!J && 1;
      ...
      if (X && !se) {
        if (K || (q.target = te, !y || !r[X] && u(X, !0) ? "feed" == X ? q.href = q.href || i.linkurl : (q.href = "/#" + X, a2a.add_event(q, "mousedown", m), a2a.add_event(q, "keydown", m), q.rel = "nofollow" + ae) : q.href = (t = X, l = n = void 0, o = p(a = q, {})["a2a-follow"], l = r[t], o && l && (n = l.url.replace("${id}", o)), n || a.href), q.a2a = {}, q.a2a.customserviceuri = re, q.a2a.stype = le, q.a2a.linkurl = i.linkurl, q.a2a.servicename = ee, q.a2a.safename = X, ie.src && (q.a2a.js_src = ie.src), ie.url && (q.a2a.url = ie.url), ie.pu && (q.a2a.popup = 1), ie.media && (q.a2a.media = 1), g.a2a_codes = g.a2a_codes || [], g.a2a_codes.push(X), y || a2a.add_event(q, "click", function (n, o, i, l, r) {
          ...
          q.appendChild($), ($ = document.createElement("span")).className = "a2a_label", $.innerHTML = ee || ("feed" == s ? a2a.c.localize.Subscribe : a2a.c.localize.Share), ee || ($.className += " a2a_localize", $.setAttribute("data-a2a-localize", "inner," + ("feed" == s ? "Subscribe" : "Share"))), q.appendChild($)
        }
  ...
  svg: {
    ...
    loadCSS: function (e) {
      var a = a2a.static_addtoany,
        ...
        l = e && o && t != a ? t + "/" : a + "/svg/";
      i.rel = "stylesheet", i.href = l + ["icons.29.svg.css", "icons.29.png.css", "icons.29.old.css"][e && o ? 0 : e ? 1 : 2], a2a.head_tag.appendChild(i), n(), a2a.svg.loadCSS = n
    },
    loadJS: function () {
      var e = document,
      ...
      t.async = !0, t.src = o + "icons.29.svg.js", n.parentNode.insertBefore(t, n), a2a.svg.loadJS = function () {}
    },
    works: function () {
      var e = document,
